...
// --- 2. O'TA NAFIS QIROLLIK ORNAMENTI (Rasm o'rniga chizilgan SVG) ---
  ...
  return (
    <div className="bg-[#FFFFFF] min-h-screen flex justify-center selection:bg-[#C5A059] selection:text-white font-sans overflow-hidden">
      <div className="w-full max-w-[460px] bg-[#FFFFFF] text-[#111111] relative overflow-x-hidden shadow-[0_0_80px_rgba(0,0,0,0.06)] border-x border-gray-100/50">
        ...
        <Head>
          <title>Sardor & Amira | Ultra Luxury Wedding</title>
            ...
            >
              ...
              <motion.div className="relative z-20 flex flex-col items-center cursor-pointer group w-full px-6" onClick={handleStart}>
                ...
                >
                  ...
                  <span className="font-['Playfair_Display'] text-[6rem] text-[#C5A059] font-medium leading-none tracking-tighter ml-2">A</span>
                </motion.div>
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="relative z-10 bg-[#FFFFFF]">
            ...
            <section className="relative h-[95svh] w-full flex flex-col items-center justify-center overflow-hidden bg-[#FFFFFF]">
              ...
              <motion.div variants={fadeUp} className="relative z-30 flex flex-col items-center mt-[-100px] w-full">
                <h1 className="font-['Playfair_Display'] text-[5rem] text-[#111] leading-[0.8] tracking-[-0.02em]">Sardor</h1>
                <div className="font-['Great_Vibes'] text-[4rem] text-[#C5A059] my-[-28px] relative z-10 rotate-[-5deg]">va</div>
                <h1 className="font-['Playfair_Display'] text-[5rem] text-[#111] leading-[0.8] tracking-[-0.02em] ml-8">Amira</h1>
                ...
                <div className="flex items-center justify-center gap-5 mt-16 w-full max-w-[280px]">
                  ...
                  <p className="font-['Montserrat'] tracking-[0.4em] text-[10px] text-[#111] font-medium">15 . 05 . 2026</p>
            ...
            {/* =========================================
                2. TAQDIR YO'LLARI (Timeline - Yangi unique bo'lim)
            ========================================= */}
            <section className="py-28 px-6 relative z-10 bg-[#FAFAFA] border-y border-gray-100">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16">
                ...
                <h2 className="font-['Playfair_Display'] text-3xl text-[#111] mb-2 tracking-wide">Taqdir Yo'llari</h2>
                <p className="font-['Montserrat'] text-[9px] uppercase tracking-widest text-gray-400">Sevgi qissasining muhim onlari</p>
              </motion.div>
              ...
              <div className="relative max-w-[320px] mx-auto">
                ...
                {[
                  { year: "2024", title: "Ilk Uchrashuv", desc: "Tasodifiy uchrashuv butun umrlik taqdirga aylanadi deb hech o'ylamagandik." },
                  { year: "2025", title: "Uzuk Taqish", desc: "Oilalarimiz roziligi bilan munosabatlarimiz rasman mustahkamlandi." },
                  { year: "2026", title: "Visol Oqshomi", desc: "Ikki qalbning mangu tutashuvi va eng baxtli kunimiz." }
                ].map((item, index) => (
                  ...
                  >
                    ...
                    <div className={`pl-14 sm:pl-0 sm:w-1/2 ${index % 2 === 0 ? 'sm:pr-10 sm:text-right' : 'sm:pl-10 sm:text-left sm:ml-auto'}`}>
                      <p className="font-['Playfair_Display'] text-[24px] text-[#C5A059] italic mb-1">{item.year}</p>
              ...
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative max-w-[360px] mx-auto text-center">
                ...
                <div className="bg-[#FFFFFF] p-12 relative z-10 rounded-sm border-[0.5px] border-[#C5A059]/40 transform rotate-[0.5deg]">
                  ...
                  <div className="font-['Playfair_Display'] text-[15px] text-gray-700 leading-[2.6] italic space-y-6 max-w-[280px] mx-auto">
                    ...
                    <p className="font-semibold text-black not-italic text-[1.1rem] leading-none my-6">Sardorjon va Amiraxonlarning</p>
                  ...
                  <div className="flex flex-col items-center gap-2 mt-16 mb-6 text-[#111111]">
                    ...
                    <div className="flex items-center justify-center gap-3 mt-2">
                      <h2 className="font-['Playfair_Display'] text-2xl font-medium tracking-widest">Ikromovlar</h2>
                      <span className="font-['Alex_Brush'] text-[#C5A059] text-2xl mt-1">va</span>
                      <h2 className="font-['Playfair_Display'] text-2xl font-medium tracking-widest">Aliyevlar</h2>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            <section className="py-24 px-8 bg-[#FAFAFA] relative z-10 border-y border-gray-100">
              ...
              <div className="relative flex flex-col items-center max-w-[340px] mx-auto">
                ...
                {[
                  { icon: Camera, time: "14:00", title: "ZAGS Marosimi", desc: "Tabiat qo'ynida esdalik lahzalari" },
                  { icon: GlassWater, time: "17:30", title: "Welcome Drink", desc: "Jonli musiqa va ohista suhbatlar" },
                ].map((event, index) => (
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative w-full flex flex-col items-center text-center bg-[#FAFAFA] py-2">
                  ...
                  <h3 className="font-['Playfair_Display'] text-[32px] text-[#C5A059] mb-1 italic font-medium">18:00</h3>
                  <h3 className="font-['Playfair_Display'] text-2xl text-[#111] mb-5 tracking-wide">Asosiy Bazm</h3>
                  <div className="border-[0.5px] border-[#C5A059]/60 px-12 py-3 bg-white shadow-sm">
                    <p className="font-['Playfair_Display'] text-[18px] text-[#111] font-medium tracking-wide">"Versal" Saroyi</p>
                  </div>
                </motion.div>
              </div>
            </section>
            ...
            <section className="py-24 px-6 bg-[#FFFFFF] relative z-10 space-y-12">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center px-4 max-w-[340px] mx-auto bg-[#FFFFFF] p-10 shadow-[0_15px_40px_rgba(0,0,0,0.04)] border-[0.5px] border-[#C5A059]/30">
                ...
                <a href="#" className="border-[0.5px] border-[#111] bg-transparent text-[#111] px-10 py-4 font-['Montserrat'] text-[9px] font-semibold tracking-[0.3em] uppercase hover:bg-[#111] hover:text-white transition-colors duration-400 inline-block">
                  Xaritada Ochish
                </a>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center px-4 max-w-[340px] mx-auto bg-[#FFFFFF] p-10 shadow-[0_15px_40px_rgba(0,0,0,0.04)] border-[0.5px] border-[#C5A059]/30">
                ...
                <p className="font-['Montserrat'] text-[11px] text-gray-500 font-light leading-relaxed mb-8">
                  Yosh oilaga o'z hissangizni qo'shishni niyat qilsangiz, quyidagi hisobdan foydalanishingiz mumkin.
                </p>
                <div className="bg-[#FAFAFA] p-6 border-[0.5px] border-[#C5A059]/40 text-center">
                  <p className="font-sans text-[#111] tracking-[0.2em] text-[18px] mb-2 font-medium">8600 1234 5678 9012</p>
                  <p className="font-['Montserrat'] text-[8px] text-[#C5A059] uppercase tracking-[0.3em] font-semibold">Sardor Ikromov</p>
                </div>
              </motion.div>
            </section>

            {/* =========================================
                6. RSVP (Yangi Unique Interaktiv Bo'lim)
            ========================================= */}
            ...
            <section className="py-32 bg-[#FAFAFA] text-center px-6 relative z-10 border-t border-gray-100">
              ...
              <div className="font-['Playfair_Display'] text-[4rem] text-[#111] leading-none tracking-wide">S & A</div>
            </section>
