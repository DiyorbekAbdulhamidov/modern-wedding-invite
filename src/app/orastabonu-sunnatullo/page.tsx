...
import { Play, Disc, MapPin, GlassWater, Heart, Sparkles, BookHeart, CalendarHeart, CheckCircle, Mail } from 'lucide-react';
...
const UltraLuxuryWedding: NextPage = () => {
  ...
  const targetDate = new Date('2026-06-13T09:30:00').getTime();
  ...
  return (
    <div className="bg-[#FFFFFF] min-h-screen flex justify-center selection:bg-[#C5A059] selection:text-white font-sans overflow-hidden">
      <div className="w-full max-w-[460px] bg-[#FFFFFF] text-[#111111] relative overflow-x-hidden shadow-[0_0_80px_rgba(0,0,0,0.06)] border-x border-gray-100/50">
        ...
        <Head>
          <title>Sunnatullo & Orastabonu | Fotiha To'yi</title>
          ...
          {!isStarted && (
            ...
            >
              <motion.div
                ...
                style={{
                  backgroundImage: "url('https://images.unsplash.com/photo-1519225421980-715cb0215aed?q=80&w=1080&auto=format&fit=crop')",
              ...
              <motion.div className="relative z-20 flex flex-col items-center cursor-pointer group w-full px-6" onClick={handleStart}>
                ...
                <motion.div
                  className="text-center mb-8 drop-shadow-[0_15px_30px_rgba(197,160,89,0.3)]"
                  animate={{ scale: [1, 1.02, 1] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                >
                  <span className="font-['Playfair_Display'] text-[6rem] text-[#C5A059] font-medium leading-none tracking-tighter">S</span>
                  <span className="font-['Playfair_Display'] text-[6rem] text-[#C5A059] font-medium leading-none tracking-tighter ml-2">&</span>
                  <span className="font-['Playfair_Display'] text-[6rem] text-[#C5A059] font-medium leading-none tracking-tighter ml-2">O</span>
                </motion.div>

                <p className="font-['Montserrat'] text-[9px] tracking-[0.6em] uppercase text-gray-800 font-semibold drop-shadow-md mb-28 text-center">
                  Fotiha To'yona Oqshomi
                </p>
                ...
                <div className="flex flex-col items-center gap-4 bg-white/50 backdrop-blur-md px-10 py-5 rounded-full border border-white/60 shadow-[0_10px_40px_rgba(0,0,0,0.1)] hover:bg-white/80 transition-all duration-700">
                  ...
                  <p className="font-['Montserrat'] text-[8px] tracking-[0.4em] uppercase text-[#111] font-semibold">Taklifnomani ochish</p>
                </div>
              </motion.div>
            </motion.div>
          )}
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="relative z-10 bg-[#FFFFFF]">
            ...
            <section className="relative h-[95svh] w-full flex flex-col items-center justify-center overflow-hidden bg-[#FFFFFF]">
              ...
              <motion.div variants={fadeUp} className="relative z-30 flex flex-col items-center mt-[-100px] w-full">
                <h1 className="font-['Playfair_Display'] text-[4rem] text-[#111] leading-[0.8] tracking-[-0.02em]">Sunnatullo</h1>
                <div className="font-['Great_Vibes'] text-[3.5rem] text-[#C5A059] my-[-22px] relative z-10 rotate-[-5deg]">va</div>
                <h1 className="font-['Playfair_Display'] text-[4rem] text-[#111] leading-[0.8] tracking-[-0.02em] ml-8">Orastabonu</h1>
                ...
                <div className="flex items-center justify-center gap-5 mt-16 w-full max-w-[280px]">
                  ...
                  <p className="font-['Montserrat'] tracking-[0.4em] text-[10px] text-[#111] font-medium">13 . 06 . 2026</p>
            ...
            {/* =========================================
                2. TAQDIR YO'LLARI
            ========================================= */}
            <section className="py-28 px-6 relative z-10 bg-[#FAFAFA] border-y border-gray-100">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16">
                <CalendarHeart className="w-7 h-7 text-[#C5A059] mx-auto mb-6 opacity-80" />
                <h2 className="font-['Playfair_Display'] text-3xl text-[#111] mb-2 tracking-wide">Baxt Bo'sog'asi</h2>
                <p className="font-['Montserrat'] text-[9px] uppercase tracking-widest text-gray-400">Ikki qalbning go'zal orzulari</p>
              </motion.div>

              <div className="relative max-w-[320px] mx-auto">
                <div className="absolute left-[20px] sm:left-1/2 top-2 bottom-2 w-[0.5px] bg-[#C5A059]/40 sm:-translate-x-1/2"></div>

                {[
                  { year: "Niyat", title: "Go'zal Shartnoma", desc: "Allohning ruxsati ila oilalarimiz roziligi va fotiha rishtasi bog'landi." },
                  { year: "Tantana", title: "Qiz Bazmi", desc: "Kelinlik ostonasida dugonalar va yaqinlar davrasida go'zal oqshom." },
                  { year: "Visol", title: "Yangi Hayot", desc: "Tez kunda hayot yo'llarimiz bir umrga mangu tutashadi, inshaalloh." }
                ].map((item, index) => (
                  <motion.div key={index} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.2 }}
                    className="relative flex items-center mb-12 sm:justify-between w-full"
                  >
                    <div className="absolute left-[16.5px] sm:left-1/2 w-2 h-2 rounded-full bg-white border border-[#C5A059] shadow-[0_0_10px_rgba(197,160,89,0.5)] sm:-translate-x-1/2 z-10"></div>

                    <div className={`pl-14 sm:pl-0 sm:w-1/2 ${index % 2 === 0 ? 'sm:pr-10 sm:text-right' : 'sm:pl-10 sm:text-left sm:ml-auto'}`}>
                      <p className="font-['Playfair_Display'] text-[22px] text-[#C5A059] italic mb-1">{item.year}</p>
                      <h4 className="font-['Montserrat'] text-[12px] font-semibold tracking-widest uppercase text-[#111] mb-2">{item.title}</h4>
                      <p className="font-['Playfair_Display'] text-[14px] text-gray-500 leading-relaxed italic">{item.desc}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <section className="py-28 px-5 bg-[#FFFFFF] relative z-10">
              ...
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative max-w-[360px] mx-auto text-center">
                ...
                <div className="bg-[#FFFFFF] p-12 relative z-10 rounded-sm border-[0.5px] border-[#C5A059]/40 transform rotate-[0.5deg]">
                  ...
                  <p className="font-['Montserrat'] text-[9px] tracking-[0.5em] text-[#C5A059] uppercase mb-12 font-semibold">Qadrli Mehmonlarimiz!</p>

                  <div className="font-['Playfair_Display'] text-[15px] text-gray-700 leading-[2.6] italic space-y-6 max-w-[280px] mx-auto">
                    <p>"Yaxshi kunlarni yaqinlar bilan baham ko'rish hayotga yanada go'zallik bag'ishlaydi. Bugun xonadonimizda quvonchli kun — go'zal niyatlar ijobati.</p>
                    <p className="font-semibold text-black not-italic text-[1.1rem] leading-none my-6">Orastabonu qizimizning</p>
                    <p>fotiha to'yi va qiz bazmi munosabati bilan yozilajak fayzli dasturxonimiz uzra siz azizlarni ko'rishdan g'oyat mamnun bo'lamiz."</p>
                  </div>

                  <div className="flex flex-col items-center gap-2 mt-16 mb-6 text-[#111111]">
                    <p className="font-['Montserrat'] tracking-[0.4em] text-[7px] uppercase opacity-60">Cheksiz ehtirom bilan,</p>
                    <div className="flex items-center justify-center gap-3 mt-2">
                      <h2 className="font-['Playfair_Display'] text-xl font-medium tracking-widest">Kelinning ota-onasi</h2>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            {/* =========================================
                4. TANTANA FAYZI (Faqat bitta vaqt)
            ========================================= */}
            <section className="py-24 px-8 bg-[#FAFAFA] relative z-10 border-y border-gray-100">
              ...
              <div className="relative flex flex-col items-center max-w-[340px] mx-auto">
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative w-full flex flex-col items-center text-center bg-[#FAFAFA] py-2">
                  ...
                  <h3 className="font-['Playfair_Display'] text-[36px] text-[#C5A059] mb-1 italic font-medium">09:30</h3>
                  <h3 className="font-['Playfair_Display'] text-2xl text-[#111] mb-2 tracking-wide">Qiz Bazmi & Fotiha Tantanasi</h3>
                  <p className="font-['Montserrat'] text-[9px] text-gray-400 tracking-widest uppercase mb-6">Tantanali marosim va fayzli dasturxon boshlanishi</p>

                  <div className="border-[0.5px] border-[#C5A059]/60 px-12 py-3 bg-white shadow-sm">
                    <p className="font-['Playfair_Display'] text-[18px] text-[#111] font-medium tracking-wide">"Moʻjiza" To'yxonasi</p>
                  </div>
                </motion.div>
              </div>
            </section>
            ...
            {/* =========================================
                5. MANZIL VA TO'YONA
            ========================================= */}
            <section className="py-24 px-6 bg-[#FFFFFF] relative z-10 space-y-12">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center px-4 max-w-[340px] mx-auto bg-[#FFFFFF] p-10 shadow-[0_15px_40px_rgba(0,0,0,0.04)] border-[0.5px] border-[0.5px] border-[#C5A059]/30">
                ...
                <p className="font-['Montserrat'] text-[11px] text-gray-500 font-light leading-relaxed mb-8">
                  Gʻuzor tumani, "Moʻjiza" toʻyxonasi.
                </p>
                <a
                  href="https://maps.app.goo.gl/vP8s9jKGcMEPvYqAA"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border-[0.5px] border-[#111] bg-transparent text-[#111] px-10 py-4 font-['Montserrat'] text-[9px] font-semibold tracking-[0.3em] uppercase hover:bg-[#111] hover:text-white transition-colors duration-400 inline-block"
                >
                  Xaritada Ochish
                </a>
              </motion.div>
              ...
              {/* <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center px-4 max-w-[340px] mx-auto bg-[#FFFFFF] p-10 shadow-[0_15px_40px_rgba(0,0,0,0.04)] border-[0.5px] border-[#C5A059]/30">
                <Heart className="w-7 h-7 text-[#C5A059] mx-auto mb-6 opacity-80" />
                <h3 className="font-['Playfair_Display'] text-2xl text-[#111] mb-5 tracking-wide">To'yona</h3>
                <p className="font-['Montserrat'] text-[11px] text-gray-500 font-light leading-relaxed mb-8">
                  Kelin-kuyovning ilk qadamlariga o'z hissangizni sovg'a tariqasida qo'shmoqchi bo'lsangiz, quyidagi hisob raqamdan foydalanishingiz mumkin.
                </p>
                <div className="bg-[#FAFAFA] p-6 border-[0.5px] border-[#C5A059]/40 text-center">
                  <p className="font-sans text-[#111] tracking-[0.2em] text-[18px] mb-2 font-medium">8600 0000 0000 0000</p>
                  <p className="font-['Montserrat'] text-[8px] text-[#C5A059] uppercase tracking-[0.3em] font-semibold">Orastabonu (Kelin tomon)</p>
                </div>
              </motion.div> */}
            </section>
            ...
            <section className="py-28 bg-[#FFFFFF] px-5 text-center relative z-10">
              ...
              <div className="flex justify-center gap-4 sm:gap-6">
                {[
                  ...
                  >
                    <p className="font-sans text-[22px] sm:text-[26px] text-[#111] font-light leading-none mb-2">{item.value}</p>
                    <p className="font-['Montserrat'] text-[8px] sm:text-[9px] text-gray-400 uppercase tracking-widest font-medium">{item.label}</p>
                  </motion.div>
                ))}
              </div>
            </section>
